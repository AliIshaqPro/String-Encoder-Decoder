...
unordered_map<char, string> alphabetttToComplexValue = {
    {'A', "apple"}, {'B', "banana"}, {'C', "cherry"}, {'D', "date"}, {'E', "elderberry"},
    {'F', "fig"}, {'G', "grape"}, {'H', "honeydew"}, {'I', "iceberg"}, {'J', "jackfruit"},
    {'K', "kiwi"}, {'L', "lemon"}, {'M', "mango"}, {'N', "nectarine"}, {'O', "orange"},
    {'P', "papaya"}, {'Q', "quince"}, {'R', "raspberry"}, {'S', "strawberry"}, {'T', "tangerine"},
    {'U', "ugli"}, {'V', "vanilla"}, {'W', "watermelon"}, {'X', "xigua"}, {'Y', "yellowfruit"},
    {'Z', "zucchini"}, {'a', "apricot"}, {'b', "blueberry"}, {'c', "cranberry"}, {'d', "dragonfruit"},
    {'e', "elderflower"}, {'f', "figgy"}, {'g', "grapefruit"}, {'h', "huckleberry"}, {'i', "indigo"},
    {'j', "jujube"}, {'k', "kumquat"}, {'l', "lime"}, {'m', "mulberry"}, {'n', "nutmeg"},
    {'o', "olive"}, {'p', "pear"}, {'q', "quinoa"}, {'r', "raisin"}, {'s', "satsuma"},
    {'t', "tomato"}, {'u', "ugni"}, {'v', "valencia"}, {'w', "walnut"}, {'x', "ximenia"},
    {'y', "yam"}, {'z', "zest"}, {' ', "space"}, {'!', "exclaim"}, {'@', "at"},
    {'#', "hash"}, {'$', "dollar"}, {'%', "percent"}, {'^', "caret"}, {'&', "ampersand"},
    {'*', "asterisk"}, {'(', "leftpar"}, {')', "rightpar"}, {'\n', "newline"},
